...
| [DA3 Person Picker](examples/da3_person_picker.py) | Shows every visible person on a depth-colored view; click one to choose who the rover follows. See [DA3 Person Picker](../docs/examples/da3-person-picker.md) for a full walkthrough. |
