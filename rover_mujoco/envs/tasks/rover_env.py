...
class RoverEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        # Observation space: base position (3) + orientation quat (4) + linear vel (3) + angular vel
        # (3)
    ...
    def _get_obs(self):
        # base_link's free joint occupies qpos[0:7] (pos + quat) and qvel[0:6] (linear + angular
        # vel)
